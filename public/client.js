...
// Rendering loop
// =====================================================================
// pick the two snapshots bracketing renderTime; sets interp fields on `frame`
...
// previous-position lookup by id (linear; entity counts are tiny) — no per-frame allocation
